...
public class Image {
  ...
  /**
   * Sets the nine-slice scaling parameters for the image. This allows the image to be scaled while
  ...
  /**
   * Disables the nine-slice scaling for the image. This will make the image scale normally without

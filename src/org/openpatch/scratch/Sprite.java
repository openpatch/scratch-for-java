...
public class Sprite {
  ...
  /**
   * Sets the handler for the whenAddedToStage event. This handler will be called when the sprite is
   * added to a stage.
   *
  ...
  /**
   * Sets the handler for the whenRemovedFromStage event. This handler will be called when the
   * sprite is removed from a stage.
   *
  ...
  /**
   * Resets the current shader to -1, which means no shader is currently active. This method can be
   * used to disable the shader effect on the sprite.
   */
   ...
   * index in the spritesheet. For example if the prefix is "tile" and the spritesheet contains 4
  ...
  /**
   * Sets the handler for when a key is pressed. This allows you to define custom behavior when a
   * key is pressed.
   *
  ...
  /**
   * Sets the handle for when a key is released. This allows you to define custom behavior when a
   * key is released.
   *
  ...
  /**
   * Sets the handler for when the mouse is moved. This allows you to define custom behavior when
   * the mouse is moved.
   *
  ...
  /**
   * Sets the handler for when the mouse is clicked. This allows you to define custom behavior when
  ...
  /**
   * Sets the handler for when the sprite is clicked. This allows you to define custom behavior when
  ...
  /**
   * Sets the handler for when a message is received. This allows you to define custom behavior.
   * This is useful when you do not want to extend the sprite class and want to use the sprite class
   * directly.
   *
   * <p>For example:
   *
  ...
  /**
   * Sets the run handler for the sprite. This allows you to define custom behavior when the sprite
   * is run.
   *
  ...
  /**
   * Creates a clone of the current sprite. The cloned sprite will have the same properties as the

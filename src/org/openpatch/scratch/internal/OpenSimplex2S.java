 ...
 *
 * <p>More language ports, as well as legacy 2014 OpenSimplex, can be found here:
...
public class OpenSimplex2S {
  ...
  /**
   * 2D OpenSimplex2S/SuperSimplex noise, with Y pointing down the main diagonal. Might be better
  ...
  private static float noise2_UnskewedBase(long seed, double xs, double ys) {
    ...
    // Second vertex.
    float a1 =
        (float) (2 * (1 + 2 * UNSKEW_2D) * (1 / UNSKEW_2D + 2)) * t
    ...
    if (t < UNSKEW_2D) {
      if (xi + xmyi > 1) {
        ...
        if (a2 > 0) {
          value +=
              (a2 * a2) * (a2 * a2) * grad(seed, xsbp + (PRIME_X << 1), ysbp + PRIME_Y, dx2, dy2);
        }
      } else {
      ...
      if (yi - xmyi > 1) {
        ...
        if (a3 > 0) {
          value +=
              (a3 * a3) * (a3 * a3) * grad(seed, xsbp + PRIME_X, ysbp + (PRIME_Y << 1), dx3, dy3);
        }
      } else {
  ...
  /**
   * 3D OpenSimplex2S/SuperSimplex noise, with better visual isotropy in (X, Y). Recommended for 3D
   * terrain and time-varied animations. The Z coordinate should always be the "different"
  ...
  /**
   * 3D OpenSimplex2S/SuperSimplex noise, with better visual isotropy in (X, Z). Recommended for 3D
   * terrain and time-varied animations. The Y coordinate should always be the "different"
   * coordinate in whatever your use case is. If Y is vertical in world coordinates, call
   ...
   * inspired by DigitalShadow. It was actually faster to narrow down the points in the loop itself,
  ...
  private static float noise3_UnrotatedBase(long seed, double xr, double yr, double zr) {
    ...
    value +=
        (a1 * a1)
            * (a1 * a1)
            * grad(seed2, xrbp + PRIME_X, yrbp + PRIME_Y, zrbp + PRIME_Z, x1, y1, z1);
  ...
  /**
   * 4D SuperSimplex noise base. Using ultra-simple 4x4x4x4 lookup partitioning. This isn't as
   * elegant or SIMD/GPU/etc. portable as other approaches, but it competes performance-wise with
   * optimized 2014 OpenSimplex.
   */
  ...
  private static float grad(
      long seed, long xrvp, long yrvp, long zrvp, float dx, float dy, float dz) {
  ...
  static {
    ...
    int[][] lookup4DVertexCodes = {
      new int[] {
        0x15, 0x45, 0x51, 0x54, 0x55, 0x56, 0x59, 0x5A, 0x65, 0x66, 0x69, 0x6A, 0x95, 0x96, 0x99,
      ...
      new int[] {
        0x01, 0x05, 0x11, 0x15, 0x41, 0x45, 0x51, 0x55, 0x56, 0x5A, 0x66, 0x6A, 0x96, 0x9A, 0xA6,
        0xAA
      },
      new int[] {
        0x01, 0x15, 0x16, 0x45, 0x46, 0x51, 0x52, 0x55, 0x56, 0x5A, 0x66, 0x6A, 0x96, 0x9A, 0xA6,
        0xAA, 0xAB
      },
      new int[] {
      ...
      new int[] {
        0x05, 0x15, 0x45, 0x55, 0x56, 0x59, 0x5A, 0x65, 0x66, 0x69, 0x6A, 0x95, 0x96, 0x99, 0x9A,
        0xAA
      },
      ...
      new int[] {
        0x04, 0x05, 0x14, 0x15, 0x44, 0x45, 0x54, 0x55, 0x59, 0x5A, 0x69, 0x6A, 0x99, 0x9A, 0xA9,
        0xAA
      },
      ...
      new int[] {
        0x04, 0x15, 0x19, 0x45, 0x49, 0x54, 0x55, 0x58, 0x59, 0x5A, 0x69, 0x6A, 0x99, 0x9A, 0xA9,
        0xAA, 0xAE
      },
      new int[] {
      ...
      new int[] {
        0x05, 0x15, 0x1A, 0x45, 0x4A, 0x55, 0x56, 0x59, 0x5A, 0x5B, 0x5E, 0x6A, 0x9A, 0xAA, 0xAB,
        0xAE, 0xAF
      },
      new int[] {
      ...
      new int[] {
        0x11, 0x15, 0x51, 0x55, 0x56, 0x59, 0x5A, 0x65, 0x66, 0x69, 0x6A, 0x95, 0x96, 0xA5, 0xA6,
        0xAA
      },
      ...
      new int[] {
        0x14, 0x15, 0x54, 0x55, 0x56, 0x59, 0x5A, 0x65, 0x66, 0x69, 0x6A, 0x95, 0x99, 0xA5, 0xA9,
        0xAA
      },
      new int[] {
      ...
      new int[] {
        0x10, 0x11, 0x14, 0x15, 0x50, 0x51, 0x54, 0x55, 0x65, 0x66, 0x69, 0x6A, 0xA5, 0xA6, 0xA9,
        0xAA
      },
      ...
      new int[] {
        0x10, 0x15, 0x25, 0x51, 0x54, 0x55, 0x61, 0x64, 0x65, 0x66, 0x69, 0x6A, 0xA5, 0xA6, 0xA9,
        0xAA, 0xBA
      },
      new int[] {
      ...
      new int[] {
        0x11, 0x15, 0x26, 0x51, 0x55, 0x56, 0x62, 0x65, 0x66, 0x67, 0x6A, 0x76, 0xA6, 0xAA, 0xAB,
        0xBA, 0xBB
      },
      new int[] {
      ...
      new int[] {
        0x14, 0x15, 0x29, 0x54, 0x55, 0x59, 0x65, 0x68, 0x69, 0x6A, 0x6D, 0x79, 0xA9, 0xAA, 0xAE,
        0xBA, 0xBE
      },
      new int[] {
      ...
      new int[] {
        0x15, 0x55, 0x56, 0x59, 0x5A, 0x65, 0x66, 0x69, 0x6A, 0x6B, 0x6E, 0x7A, 0xAA, 0xAB, 0xAE,
        0xBA, 0xBF
      },
      new int[] {
      ...
      new int[] {
        0x41, 0x45, 0x51, 0x55, 0x56, 0x59, 0x5A, 0x65, 0x66, 0x95, 0x96, 0x99, 0x9A, 0xA5, 0xA6,
        0xAA
      },
      ...
      new int[] {
        0x44, 0x45, 0x54, 0x55, 0x56, 0x59, 0x5A, 0x65, 0x69, 0x95, 0x96, 0x99, 0x9A, 0xA5, 0xA9,
        0xAA
      },
      new int[] {
      ...
      new int[] {
        0x50, 0x51, 0x54, 0x55, 0x56, 0x59, 0x65, 0x66, 0x69, 0x95, 0x96, 0x99, 0xA5, 0xA6, 0xA9,
        0xAA
      },
      new int[] {
      ...
      new int[] {
        0x55, 0x56, 0x59, 0x5A, 0x65, 0x66, 0x69, 0x6A, 0x95, 0x96, 0x99, 0x9A, 0xA5, 0xA6, 0xA9,
        0xAA
      },
      new int[] {
        0x15, 0x45, 0x51, 0x55, 0x56, 0x59, 0x5A, 0x65, 0x66, 0x6A, 0x95, 0x96, 0x9A, 0xA6, 0xAA,
      ...
      new int[] {
        0x15, 0x45, 0x55, 0x56, 0x59, 0x5A, 0x65, 0x66, 0x69, 0x6A, 0x95, 0x96, 0x99, 0x9A, 0xA6,
        0xA9, 0xAA, 0xAB, 0xAE
      },
      ...
      new int[] {
        0x15, 0x51, 0x55, 0x56, 0x59, 0x5A, 0x65, 0x66, 0x69, 0x6A, 0x95, 0x96, 0x9A, 0xA5, 0xA6,
        0xA9, 0xAA, 0xAB, 0xBA
      },
      ...
      new int[] {
        0x15, 0x54, 0x55, 0x56, 0x59, 0x5A, 0x65, 0x66, 0x69, 0x6A, 0x95, 0x99, 0x9A, 0xA5, 0xA6,
        0xA9, 0xAA, 0xAE, 0xBA
      },
      ...
      new int[] {
        0x40, 0x41, 0x44, 0x45, 0x50, 0x51, 0x54, 0x55, 0x95, 0x96, 0x99, 0x9A, 0xA5, 0xA6, 0xA9,
        0xAA
      },
      ...
      new int[] {
        0x45, 0x51, 0x55, 0x56, 0x59, 0x5A, 0x65, 0x66, 0x6A, 0x95, 0x96, 0x99, 0x9A, 0xA5, 0xA6,
        0xA9, 0xAA, 0xAB, 0xEA
      },
      ...
      new int[] {
        0x45, 0x54, 0x55, 0x56, 0x59, 0x5A, 0x65, 0x69, 0x6A, 0x95, 0x96, 0x99, 0x9A, 0xA5, 0xA6,
        0xA9, 0xAA, 0xAE, 0xEA
      },
      ...
      new int[] {
        0x51, 0x54, 0x55, 0x56, 0x59, 0x65, 0x66, 0x69, 0x6A, 0x95, 0x96, 0x99, 0x9A, 0xA5, 0xA6,
        0xA9, 0xAA, 0xBA, 0xEA
      },
      ...
      new int[] {
        0x55, 0x56, 0x59, 0x5A, 0x66, 0x69, 0x6A, 0x96, 0x99, 0x9A, 0xA6, 0xA9, 0xAA, 0xAB, 0xAE,
        0xAF
      },
      new int[] {
      ...
      new int[] {
        0x55, 0x56, 0x5A, 0x65, 0x66, 0x69, 0x6A, 0x96, 0x9A, 0xA5, 0xA6, 0xA9, 0xAA, 0xAB, 0xBA,
        0xBB
      },
      new int[] {
      ...
      new int[] {
        0x55, 0x59, 0x5A, 0x65, 0x66, 0x69, 0x6A, 0x99, 0x9A, 0xA5, 0xA6, 0xA9, 0xAA, 0xAE, 0xBA,
        0xBE
      },
      new int[] {
      ...
      new int[] {
        0x40, 0x45, 0x51, 0x54, 0x55, 0x85, 0x91, 0x94, 0x95, 0x96, 0x99, 0x9A, 0xA5, 0xA6, 0xA9,
        0xAA, 0xEA
      },
      new int[] {
      ...
      new int[] {
        0x41, 0x45, 0x51, 0x55, 0x56, 0x86, 0x92, 0x95, 0x96, 0x97, 0x9A, 0xA6, 0xAA, 0xAB, 0xD6,
        0xEA, 0xEB
      },
      new int[] {
      ...
      new int[] {
        0x44, 0x45, 0x54, 0x55, 0x59, 0x89, 0x95, 0x98, 0x99, 0x9A, 0x9D, 0xA9, 0xAA, 0xAE, 0xD9,
        0xEA, 0xEE
      },
      new int[] {
      ...
      new int[] {
        0x45, 0x55, 0x56, 0x59, 0x5A, 0x95, 0x96, 0x99, 0x9A, 0x9B, 0x9E, 0xAA, 0xAB, 0xAE, 0xDA,
        0xEA, 0xEF
      },
      new int[] {
      ...
      new int[] {
        0x55, 0x56, 0x5A, 0x66, 0x6A, 0x95, 0x96, 0x99, 0x9A, 0xA5, 0xA6, 0xA9, 0xAA, 0xAB, 0xEA,
        0xEB
      },
      new int[] {
      ...
      new int[] {
        0x55, 0x59, 0x5A, 0x69, 0x6A, 0x95, 0x96, 0x99, 0x9A, 0xA5, 0xA6, 0xA9, 0xAA, 0xAE, 0xEA,
        0xEE
      },
      new int[] {
      ...
      new int[] {
        0x50, 0x51, 0x54, 0x55, 0x65, 0x95, 0xA1, 0xA4, 0xA5, 0xA6, 0xA9, 0xAA, 0xB5, 0xBA, 0xE5,
        0xEA, 0xFA
      },
      new int[] {
      ...
      new int[] {
        0x51, 0x55, 0x56, 0x65, 0x66, 0x95, 0x96, 0xA5, 0xA6, 0xA7, 0xAA, 0xAB, 0xB6, 0xBA, 0xE6,
        0xEA, 0xFB
      },
      new int[] {
      ...
      new int[] {
        0x55, 0x65, 0x66, 0x69, 0x6A, 0x95, 0x96, 0x99, 0x9A, 0xA5, 0xA6, 0xA9, 0xAA, 0xBA, 0xEA,
        0xFA
      },
      new int[] {
      ...
      new int[] {
        0x54, 0x55, 0x59, 0x65, 0x69, 0x95, 0x99, 0xA5, 0xA9, 0xAA, 0xAD, 0xAE, 0xB9, 0xBA, 0xE9,
        0xEA, 0xFE
      },

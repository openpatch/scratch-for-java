 ...
 * These constants represent various keys on a keyboard including:
 * <ul>
 *   <li>Standard character keys (letters, numbers, symbols)</li>
 *   <li>Function keys (F1-F24)</li>
 *   <li>Navigation keys (arrows, home, end, etc.)</li>
 *   <li>Modifier keys (shift, ctrl, alt, etc.)</li>
 *   <li>Numpad keys</li>
 *   <li>Special keys for international keyboards</li>
 *   <li>Media and system control keys</li>
 * </ul>
 * 
 * The key codes are defined as integer constants and follow common virtual key code
 * standards used in various platforms. Many of these codes align with ASCII values
 * for basic characters, while others use platform-specific ranges for special keys.
 * 
 * <p>This class includes support for:
 * <ul>
 *   <li>Standard US QWERTY keyboard layout</li>
 *   <li>European keyboard specific keys</li>
 *   <li>Asian keyboard specific keys (Japanese, Korean, etc.)</li>
 *   <li>Sun keyboard specific functions</li>
 *   <li>Microsoft Windows specific keys</li>
 * </ul>
 * 
 * <p>The constants in this class are intended to be used for keyboard event handling
 * and key mapping operations.
 */

...
class MyStage extends Stage {
  ...
  public MyStage() {
    ...
    this.setCursor("UI/crosshair_color_c.png");
...
class Button extends Sprite {
  public Button() {
    super();
    this.addCostume("metal-panel-green-corner", "UI/metalPanel_greenCorner.png");
...
class Bar extends Sprite {
  public Bar() {
    super();
    this.addCostume("bar", "UI/bar_round_gloss_large.png");
    this.addCostume("bar-gray", "UI/bar_round_gloss_large_gray.png");
